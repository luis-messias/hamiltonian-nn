...
def train(args):
  ...
  nn_model = MLP(args.input_dim, args.hidden_dim, output_dim, args.nonlinearity).to(args.device)
  model = HNN(args.input_dim, differentiable_model=nn_model,
              field_type=args.field_type, baseline=args.baseline).to(args.device)
  model.M = model.M.to(args.device)
  ...
  test_dxdt = torch.Tensor(data['test_dx']).to(args.device)
